            ...
            ?>
                ...
                <div class="d-flex justify-content-center">
                    <div class="form-group btn btn-success" style="cursor: default;">
                        ...
                        <input type="text" id="subtotal" value="<?php echo number_format($grandTotal, 0, ',', '.') ?>" class="form-control text-center" style="cursor: default;" readonly>
                    </div>
                </div>
                <h3>Isikan data dengan benar</h5>
                    <form method="post" action="<?php echo base_url() ?>dashboard/proses_pesanan">
                        <!-- Form elements -->
                        <!-- <div class="form-group btn btn-secondary ">
                    <label for="">Total Belanjaan</label>
                    <input type="text" id="totalBelanja" value="<?php echo number_format($grandTotal, 0, ',', '.') ?>" class="form-control" readonly>
                </div> -->
