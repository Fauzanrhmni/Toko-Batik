        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color:#4E73DF;" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome') ?>">
                <div class="sidebar-brand-icon ">
                    ...
                    <i class="fas fa-pen-fancy fa-flip-horizontal fa-xs"></i>
                </div>
                <div class="sidebar-brand-text mx-5">BaTas</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('kategori/pakaian_wanita') ?>">
                    <i class="fas fa-fw fa-tshirt"></i>
                    <span>Batik Wanita</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('dashboard/status') ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?= base_url('welcome/cari_barang') ?>" method="GET">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- Ikon Keranjang sebagai Tautan ke Detail Keranjang -->
                        <div class="navbar">
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    ...
                                    ?>
                                    <?php echo anchor('dashboard/detail_keranjang', '<i class="fa fa-shopping-cart"></i>' . $total_items)  ?>
                                </li>
                            </ul>
...
<img class=img-profile rounded-circle" src="<?php echo base_url() ?>assets/img/undraw_porfile_5.svg">
</a>
